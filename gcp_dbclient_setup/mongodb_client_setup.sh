...
# Loop through all deployed benchmarking client machines and start BenchmarkingClientApplication for MongoDB
...
do 
    ...
    gcloud compute ssh $currentInstanceName --zone $zone -- "sudo java -Xms2g -Xmx24g -jar $JAR_DEST_MONGODB"
